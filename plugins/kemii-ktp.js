...
let handler = async (m, { conn, args, usedPrefix }) => {
    ...
    if (!args[0]) return conn.reply(m.chat,  `.ktp 6288980870067|Elisabeth|Jakarta, 02-07-2023|Sheila|Jepang|Perempuan|Alamat Lu|Rt Rw Lu|Kelurahan Lu|Kecamatan Lu|Islam|Belum Kawin|Suka Mundur|Mahasiswa|Seumur Hidup`, m)
