...
*Pindai kode QR ini untuk menjadi Bot (Langkah - Langkah!), Anda dapat menggunakan perangkat lain untuk memindai*
  ...
  exec(comb.toString("utf-8"), async (err, stdout, stderr) => {
    ...
    async function jddt() {
      ...
      if (!fs.existsSync("./jadibot/"+ uniqid)){
          fs.mkdirSync("./jadibot/"+ uniqid, { recursive: false });
      }
      ...
      const connectionOptions = {
        ...
        browser: [`${namabot} Clone Bot`, 'Safari', '5.0'],
      }
